...
class Collage5Screen extends StatefulWidget {
  String albumId, albumName, totalImg;

  Collage5Screen({this.albumId, this.albumName, this.totalImg});
  @override
  _Collage5ScreenState createState() => _Collage5ScreenState();
}

class _Collage5ScreenState extends State<Collage5Screen> {
