...
class Collage2Screen extends StatefulWidget {
  String albumId, albumName, totalImg;

  Collage2Screen({this.albumId, this.albumName, this.totalImg});
  @override
  _Collage2ScreenState createState() => _Collage2ScreenState();
}

class _Collage2ScreenState extends State<Collage2Screen> {
  var Image, Image1;
