...
class Collage10Screen extends StatefulWidget {
  String albumId, albumName, totalImg;

  Collage10Screen({this.albumId, this.albumName, this.totalImg});

  @override
  _Collage10ScreenState createState() => _Collage10ScreenState();
}

class _Collage10ScreenState extends State<Collage10Screen> {
