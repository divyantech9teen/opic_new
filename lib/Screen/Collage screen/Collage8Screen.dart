...
class Collage8Screen extends StatefulWidget {
  String albumId, albumName, totalImg;

  Collage8Screen({this.albumId, this.albumName, this.totalImg});

  @override
  _Collage8ScreenState createState() => _Collage8ScreenState();
}

class _Collage8ScreenState extends State<Collage8Screen> {
