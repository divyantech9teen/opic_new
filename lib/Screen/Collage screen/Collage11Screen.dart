...
class Collage11Screen extends StatefulWidget {
  String albumId, albumName, totalImg;

  Collage11Screen({this.albumId, this.albumName, this.totalImg});

  @override
  _Collage11ScreenState createState() => _Collage11ScreenState();
}

class _Collage11ScreenState extends State<Collage11Screen> {
