...
class Collage3Screen extends StatefulWidget {
  String albumId, albumName, totalImg;

  Collage3Screen({this.albumId, this.albumName, this.totalImg});

  @override
  _Collage3ScreenState createState() => _Collage3ScreenState();
}

class _Collage3ScreenState extends State<Collage3Screen> {
