...
class Collage7Screen extends StatefulWidget {
  String albumId, albumName, totalImg;

  Collage7Screen({this.albumId, this.albumName, this.totalImg});

  @override
  _Collage7ScreenState createState() => _Collage7ScreenState();
}

class _Collage7ScreenState extends State<Collage7Screen> {
